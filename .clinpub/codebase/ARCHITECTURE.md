...
**State Management:**
- Project state tracked in `project_config.yml` and `.clinpub/STATE.md`
- `.clinpub/STATE.md` tracks: current_phase, completed milestones, pending decisions, blockers
- `.clinpub/ROADMAP.md` tracks: all phases with status (Complete/In Progress/Not Started)
- Each phase has its own context log in `.clinpub/phases/NN-phase-name/00-CONTEXT.md`
- Phase gate completions recorded in `.clinpub/phases/NN-phase-name/MILESTONE.md`
...
- **Global state**: `.clinpub/STATE.md` and `.clinpub/ROADMAP.md` act as shared state. Only orchestrator (not agents) updates these files.
...
**Logging:** Not formalized. Phase context logs are written to `.clinpub/phases/NN-phase-name/00-CONTEXT.md`. No centralized logging framework.
