...
- **D-03:** 每个调研 Phase 产出 `RESEARCH.md` 文件，位于该 Phase 目录下（如 `.clinpub/phases/06-引用策略/06-RESEARCH.md`），在 CONTEXT.md 之前生成
...
- **D-10:** codebase 扫描使用现有 `.clinpub/codebase/` 地图文件（ARCHITECTURE.md, CONVENTIONS.md, STRUCTURE.md, INTEGRATIONS.md），无需额外扫描逻辑
...
### 代码库地图
- `.clinpub/codebase/ARCHITECTURE.md` — 系统架构概览
- `.clinpub/codebase/CONVENTIONS.md` — 代码规范与约定
- `.clinpub/codebase/STRUCTURE.md` — 目录结构
- `.clinpub/codebase/INTEGRATIONS.md` — 外部集成与工具
...
### 需求定义
- `.clinpub/REQUIREMENTS.md` §FLOW-01 — 每个 Phase 前先调研，以建议方式与用户讨论，结合用户反馈再执行
...
- `.clinpub/codebase/*.md` — 6 个代码库地图文件，直接用于 Track B 的技术调研
